...
2048 게임 로직, 오픈소스 코드는 노트북LM 을 통해서 분석을하고, 구글 안티그래비 (Antigravity) 바이브 코딩용 프롬프트 를 만들어 달라고 했습니다.

[프롬프트 시작]
너는 10년 차 프론트엔드 개발자이자 웹 게임 디자인 전문가야. HTML5, CSS3, JavaScript(또는 React)를 사용하여 '제온스(Xeons)' 회사의 브랜드 홍보를 위한 모던한 2048 웹 게임을 개발해 줘.
